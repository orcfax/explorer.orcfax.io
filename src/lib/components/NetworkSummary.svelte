...
<section class="flex flex-col items-center">
	...
	<div class="section-container">
		<div class="flex flex-col space-y-7">
			<ul class="grid gap-7 max-h-fit grid-cols-1 xs:grid-cols-2 sm:grid-cols-3">
				<li>
					<Card.Root class="h-full">
						<Card.Header
							class="flex flex-row items-center justify-between space-y-0 space-x-2 pb-0"
						>
				...
				<li>
					<Card.Root class="h-full">
						<Card.Header
							class="flex flex-row items-center justify-between space-y-0 space-x-6 pb-0"
						>
			...
			<div class="grid gap-7 max-h-fit grid-cols-3">
